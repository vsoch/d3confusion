datadir = "/home/vanessa/Documents/Work/BRAINMETA/IMAGE_COMPARISON/experiment3_unrelated/permutations"
setwd(datadir)
input_data = list.files(datadir,pattern="confmatrix*")
outdir = "/home/vanessa/Documents/Dropbox/Code/Flask/confusion/static"
...
for (i in input_data) {
	...
	write.table(flat,file=paste(outdir,"/",strategy,"_",metric,"_",direction,"_",threshold,".tsv",sep=""),sep="\t",row.names=FALSE,col.names=TRUE,quote=FALSE)
}
