...
def get_accuracy(strategy,metric,threshold,direction):
...
def show_best_analysis():
    ...
    acc = get_accuracy(strategy,metric,threshold,direction)
...
def show_specific_analysis(strategy,metric,direction,threshold):

    datafile = "%s_%s_%s.tsv" %(strategy,metric,direction,threshold)
